...
#    group_names = ["Age", "Ethnicity", "Sex", "Smoker"]
 #   plt.gca().set_prop_cycle(None)
    plt.rcParams['axes.prop_cycle'] = cycler('color', plt.get_cmap('tab20').colors)
 #   color_cycle = list(cycler('color', plt.get_cmap('tab20').colors))
#    print(color_cycle)
...
if __name__ == "__main__":
 ...
 #   calc_ppv.write_to_results()
    ...
    if barplot == True:
            results_list = glob.glob("/MULTIX/DATA/HOME/covid-19-benchmarking/results/xvitcos_seg/ltht/*.json")
...
#                y_ticks = [1.0, 4, 7., 10, 12.25]
 ...
 #                    break
#                break
            fig1.savefig('/MULTIX/DATA/HOME/covid-19-benchmarking/results/xvitcos_seg/ltht/subpop_fnr_fpr_bar_comp_new.pdf')
