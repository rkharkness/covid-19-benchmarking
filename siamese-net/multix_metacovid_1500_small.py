...
def save_best_model(model, epoch):
  print("saving model ...")
  torch.save(model.state_dict(), "/home/ubuntu/multix_metacovid_1500_{}.pth".format(epoch))
...
def train(num_epoch, scheduler=scheduler, criterion=criterion, optimizer=optimizer, patience=25):
    ...
    return counter, loss_history, val_loss_history

counter, loss_history, val_loss_history = train(500)
