...
if __name__ == '__main__':
    ...
    base = '/MULTIX/DATA/HOME/lung_segmentation_data'
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = 'Task510_LungSeg'
    nnUNet_raw_data = '/MULTIX/DATA/HOME/nnUNet_raw_data_base/nnUNet_raw_data'
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, ('Red', 'Green', 'Blue'),
                          labels={0: 'background', 1: 'lung'}, dataset_name=task_name, license='hands off!')
